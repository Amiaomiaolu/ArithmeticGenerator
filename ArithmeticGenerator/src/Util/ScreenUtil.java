...
public class ScreenUtil {
    static ScreenUtil screen = new ScreenUtil();
    ...
    public String espressionResult(String exps){
        ...
        String[] exps_array = ScreenUtil.splitExpression(exps);//得到分隔后的字符串数组
        //默认左右运算数用double运算
    ...
    public int[] operator(String total_exps){
        String[] exps_array = ScreenUtil.splitExpression(total_exps);//得到分隔后的字符串数组
     ...
     * @return 返回字符串数组
     */
    public static String[] splitExpression(String exps){
        //以空格为标志
