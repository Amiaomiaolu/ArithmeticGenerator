...
public class CreateExpression {
    ...
    private static String[] questions =new String[InputUtil.num];
    private static String[] answers  =new String[InputUtil.num];

    private static String[] getQuestions =new String[InputUtil.num];
    private static String[] getAnswers =new String[InputUtil.num];
    ...
    public static void outCorrectExpression(int num, int limits, File exercise,File answer) throws Exception{
        ...
        // 正确的表达式 写入练习文件
        FIleUtil.write(exercise,questions);
